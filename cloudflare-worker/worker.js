// ============================================
// ALLEY 28 MENU – CLOUDFLARE WORKER PROXY
// Deploy at: alley28-menu-proxy.f-klavun.workers.dev
//
...
//   GITHUB_REPO     – Repository Name (z.B. alley28-menu)
    ...
    async fetch(request, env) {
        ...
        if (request.method === 'POST') {
            ...
            const res = await fetch(githubApiUrl, {
                ...
                body: JSON.stringify({
                    message: `Admin: Alley 28 Speisekarte (${menuFile}) aktualisiert`,
